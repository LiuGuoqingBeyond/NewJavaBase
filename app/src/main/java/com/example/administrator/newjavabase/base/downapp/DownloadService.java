...
/**
 * If there is no bug, then it is created by chengxingjiang on 2017/11/19,
 * or created by other,
 */
public class DownloadService extends Service {
    ...
    public class DownloadBinder extends Binder {
        ...
        public long startDownload(String apkUrl) {
            //点击下载
            //删除原有的APK
            SystemManager.clearApk(DownloadService.this, "agent_pos.apk");
            //使用DownLoadManager来下载
            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(apkUrl));
            //将文件下载到自己的Download文件夹下,必须是External的
            //这是DownloadManager的限制
            File file = new File(getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "agent_pos.apk");
    ...
    private class DownloadFinishReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!TextUtils.isEmpty(apkPath)) {
                ...
                SystemManager.install(context, apkPath, mIsRoot);
            } else {
